    ...
    return (
        <>
            ...
            <div className= "grid grid-rows-10 fixed h-screen top-0 right-0 w-full sm:w-4/5 md:w-4/5 lg:w-4/5 justify-center overflow-y-scroll">
                ...
                <div className="mt-12 mx-24 sm:mx-28 md:mx-36 lg:mx-48 text-medium text-white font-calibri whitespace-pre-line">
                ...
                <div className="mx-24 sm:mx-28 md:mx-36 lg:mx-48 text-xl text-white font-calibri whitespace-pre-line">
                    1. Use of the App <br /> <br />
                </div>

                <div className="mx-24 sm:mx-28 md:mx-36 lg:mx-48 text-medium text-white font-calibri whitespace-pre-line">
